...
class SuspiciousLoginAttemptEmail extends Mailable
{
    ...
    public function build()
    {
        ...
        $setting['body'] = str_replace('{{platform}}', $this->login_attempt->agent->browser, $setting['body']);
        $setting['body'] = str_replace('{{status}}', $this->login_attempt->login_status, $setting['body']);
