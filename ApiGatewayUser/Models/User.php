...
namespace ApiGatewayUser\Models;
...
use ApiGatewayUser\database\factories\UserFactory;
use ApiGatewayUser\Jobs\EmailJob;
use ApiGatewayUser\Mail\User\EmailVerifyOtp;
use ApiGatewayUser\Mail\User\ForgetPasswordOtpEmail;
use ApiGatewayUser\Mail\User\WelcomeEmail;
use ApiGatewayUser\Support\UserActivityHelper;
use Spatie\Permission\Traits\HasRoles;

/**
 * ApiGatewayUser\Models\User
 *
 ...
 * @property-read \Illuminate\Database\Eloquent\Collection|\ApiGatewayUser\Models\LoginAttempt[] $loginAttempts
 * @property-read int|null $login_attempts_count
 * @property int $is_email_verified
 * @property string|null $email_verified_at
 * @property-read \Illuminate\Database\Eloquent\Collection|\ApiGatewayUser\Models\Otp[] $otps
